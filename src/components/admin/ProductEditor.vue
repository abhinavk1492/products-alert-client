<template>
  <div>
    <h2 class="text-center p-2">{{ editMode ? "Edit Product" : "Add Product" }}</h2>

    <!-- <h4 class="bg-danger text-white text-center p-2">Values Required for All Fields!</h4> -->
    ...
    <div class="text-center">
      ...
      <button class="btn btn-primary m-1" @click="handleProduct">{{ editMode ? "Edit" : "Add" }}</button>
    </div>
  </div>
</template>
